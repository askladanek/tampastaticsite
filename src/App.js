      ...
      <Container>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-tampa-convention-center">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.tampagov.net/tcc/home" className="App-Link"> More Information
            </a>
            <br />
        ...
        <Row className="App-Row" >
          <div id = "hotspot-unlock-tampa-bay-visitors-center">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.visittampabay.com/visitors-center/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-the-florida-aquarium">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://www.flaquarium.org/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-sparkman-wharf">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://sparkmanwharf.com/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-tampa-bay-history-center">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://tampabayhistorycenter.org/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-amalie-arena">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://www.amaliearena.com/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-pirate-water-taxi">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://www.piratewatertaxi.com/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-tampa-theatre">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://tampatheatre.org/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item >
        ...
        <Row className="App-Row" >
          <div id = "hotspot-glazer-children's-museum">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://glazermuseum.org/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-curtis-hixon-waterfront-park">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.tampagov.net/parks-and-recreation/featured-parks/curtis-hixon" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-tampa-museum-of-art">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://tampamuseum.org/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item >
        ...
        <Row className="App-Row" >
          <div id = "hotspot-straz-center">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://www.strazcenter.org/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item >
        ...
        <Row className="App-Row" >
          <div id = "hotspot-armature-works">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://armatureworks.com/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-julian-lane-riverfront-park">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.tampa.gov/parks-and-recreation/featured-parks/riverfrontpark" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-perry-harvey-park">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.tampagov.net/parks-and-recreation/improvements/completed/perry-harvey-sr" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-henry-plant-museum">
            ...
            <a target="_blank" rel="noopener noreferrer" href="http://www.ut.edu/plantmuseum/" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
        ...
        <Row className="App-Row" >
          <div id = "hotspot-bayshore-boulevard">
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.tampa.gov/parks-and-recreation/programs/parks-and-facilities/greenways-and-trails/projects-under-development/bayshore-boulevard-greenway" className="App-Link"> More Information
            </a>
            <br />
            <Carousel className="App-Media">
              <Carousel.Item>
